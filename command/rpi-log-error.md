---
description: logs user trajectory with agent on error to help improve agent harnessing
---
...
Error-log file: error-YYYY-MM-DD-ID.md
Metadata (for ID tracking): in the frontmatter of the MD file
## Your Task
1. Review the conversation to identify what went wrong.
2. Ask 5-8 pointed questions focused on USER behavior, such as (adjust dynamically to the conversation user had):
...
## Log Template in Markdown
```markdown
---
ID: [ID]
Description: [Short Descriptive Name]
Date: [Date]
Project: [What were you working on]
---
...
3. [Consider adding to personal AGENTS.md or workflow]
